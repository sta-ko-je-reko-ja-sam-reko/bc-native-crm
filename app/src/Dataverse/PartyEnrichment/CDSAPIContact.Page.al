...
/// <summary>
/// API page over Contact — a full clone of Microsoft's APIV2 Contacts page (so integrations/MCP see the whole
/// contact: name, address, phone, email, company, …) plus the CRM affix fields (ownership + consent/preferences).
...
page 50125 "NBC CDS API Contact"
{
    ...
    APIGroup = 'party';
    APIVersion = 'v1.0';
    EntityCaption = 'Contact CRM';
    EntitySetCaption = 'Contacts CRM';
    ChangeTrackingAllowed = true;
    DelayedInsert = true;
    EntityName = 'contactCrm';
    EntitySetName = 'contactsCrm';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                // --- NBC CRM affix fields (ownership + consent/preferences tableextensions) ---
